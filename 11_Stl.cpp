...
vector<Item> o1;                     //ek vector banavla tyat che item store hotyat tyacha data type Item ahe mnjhe it will have name,quantity...
void print(Item &i1);
void display();
void insert();
void search();
...
void insert()
{
 ...
 cout<<"\nEnter Item Code:";
 cin>>i1.code;
 o1.push_back(i1);             //adhi sagla store kela and mag nantar apla user defined data type push kela vector madhe 
}
